...
class DetailScreen(QtWidgets.QDialog):
    ...
    def setupUi(self, background_detail_screen):
        ...
        self.text_header_summary_screen.setStyleSheet("font: 75 34pt \"TH Sarabun New\";")
        ...
        # Edit button
        self.button_edit_pill = self.create_tool_button("แก้ไข", background_detail_screen, self.goToEditPage, QtCore.QRect(295, 400, 220, 75))
        self.button_edit_pill.setStyleSheet("QToolButton { font: 36pt \"TH Sarabun New\"; background-color:#FFD700; color: #ffffff; border-radius:20px; }")
        ...
        self.button_delete_pill_channel.setStyleSheet("QToolButton { font: 36pt \"TH Sarabun New\"; background-color:#DD5D5D; color: #ffffff; border-radius:20px; }")
        ...
        self.no_channel.setStyleSheet("background-color: #C5E1FF; font: 36pt \"TH Sarabun New\"; border-radius: 25px; color: #070021;")
    ...
    def retranslateUi(self, background_detail_screen):
        ...
        self.button_edit_pill.setText(_translate("background_detail_screen", "แก้ไข"))

    def create_label(self, text, parent):
        label = QtWidgets.QLabel(text, parent)
        label.setMinimumSize(250, 35)
        label.setMaximumSize(400, 100)
        label.setStyleSheet("background-color: #C5E1FF; font: 75 30pt \"TH Sarabun New\"; border-radius: 25px; color: #070021;")
    ...
    def create_data_label(self, text, parent):
        ...
        label.setStyleSheet("font: 75 34pt \"TH Sarabun New\"; color: #070021;")
        return label

    def create_tool_button(self, text, parent, click_action, geometry):
        button = QtWidgets.QToolButton(parent)
        button.setGeometry(geometry)
        button.setStyleSheet("QToolButton { font: 36pt \"TH Sarabun New\"; background-color:#24BD73; color: #ffffff; border-radius:20px; }")
