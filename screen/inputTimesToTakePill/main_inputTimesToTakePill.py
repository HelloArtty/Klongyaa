...
class InputTimeToTakePillScreen(QDialog):
    ...
    def setupUi(self, background_input_times_to_take_pill):
        ...
        self.question_input_times_to_take_pill.setGeometry(QtCore.QRect(80, 110, 620, 200))
        ...
        self.button_input_times_to_take_pill.setGeometry(QtCore.QRect(330, 300, 140, 125))
...
class AddSummaryTimeScreen(QDialog):
    ...
    def setupUi(self, background_confirm_times_to_take_pill):
        ...
        self.success_button.setGeometry(QtCore.QRect(275, 370, 250, 90))
